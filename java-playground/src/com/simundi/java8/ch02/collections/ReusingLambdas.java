...
public class ReusingLambdas {
    ...
    public static final List<String> friends = Arrays
        .asList("Sandro", "Thiago", "Nandinho", "Guto", "Guitierrez", "Baxinho", "Nego Jony");
    ...
    final static Predicate<String> filterWithG = (String name) -> name.startsWith("G");
